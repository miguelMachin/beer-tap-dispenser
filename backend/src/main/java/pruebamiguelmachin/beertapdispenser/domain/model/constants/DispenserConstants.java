package pruebamiguelmachin.beertapdispenser.domain.model.constants;

public class DispenserConstants {

    public static final String DISPENSER_NOT_FOUND_MESSAGE_ERROR = "Dispenser with id %s not found";
